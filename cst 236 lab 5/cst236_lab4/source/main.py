...
from git_utils import check_valid_path, get_git_file_info, get_file_info, get_repo_branch, get_repo_url
...
class Interface(object):
    def __init__(self):
        ...
        self.question_answers = {
            ...
            'Is the file path in the repo?': QA(' When asked is the file path in the repo?', check_valid_path),
