...
from git_utils import get_file_info, get_git_file_info, is_file_in_repo, has_untracked_files, get_repo_url, \
    get_repo_branch
import time
...
class TestFilePath(TestCase):
    ...
    def test_file_path(self, mock_subproc_popen):
        ...
        x = is_file_in_repo("C:\Users\Zed\Desktop\cst 236 lab 6\cst236_lab4\projectRequirements.txt")
        self.assertTrue(x)
    ...
    def test_status_of_file_modified(self, mock_subproc_popen):
        process_mock = mock.Mock()
        attrs = {'communicate.return_value': (
            "C:\\Users\Zed\Desktop\cst 236 lab 6\cst236_lab4\projectRequirements.txt", '')}
        process_mock.configure_mock(**attrs)
        mock_subproc_popen.return_value = process_mock
        x = get_git_file_info("C:\Users\Zed\Desktop\cst 236 lab 6\cst236_lab4\projectRequirements.txt")
    ...
    def test_is_file_in_repo(self, mock_subproc_popen):
        ...
        process_mock.configure_mock(**attrs)
        mock_subproc_popen.return_value = process_mock
        x = is_file_in_repo("projectRequirements.txt")
        self.assertTrue(x)
        self.assertTrue(mock_subproc_popen.called)
    ...
    def test_untracked_file(self, mock_subproc_popen):
        ...
        process_mock.configure_mock(**attrs)
        mock_subproc_popen.return_value = process_mock
        x = has_untracked_files("C:\Users\Zed\Desktop\cst 236 lab 6\cst236_lab4\projectRequirements.txt")
        self.assertTrue(x)
        self.assertTrue(mock_subproc_popen.called)
    ...
    def test_get_git_file_exce(self, mock_subproc_popen):
        ...
        mock_subproc_popen.return_value = process_mock
        x = "c"
        self.assertRaisesRegexp(Exception, 'Path c does not exist cannot get git file', get_git_file_info, x)
    ...
    def test_get_file_info(self, mock_subproc_popen):
        ...
        process_mock.configure_mock(**attrs)
        mock_subproc_popen.return_value = process_mock
        x = get_file_info("projectRequirements.txt")
        self.assertTrue(x)
        self.assertTrue(mock_subproc_popen.called)
    ...
    def test_get_repo_branch(self, mock_subproc_popen):
        ...
        process_mock.configure_mock(**attrs)
        mock_subproc_popen.return_value = process_mock
        x = get_repo_branch("projectRequirements.txt")
        self.assertTrue(x)
        self.assertTrue(mock_subproc_popen.called)
